...
You can find the i18n locale for the Spreadsheet popup with descriptions for formulas in the `dhx.i18n.formulas` object. The complete default English locale is listed below.

For instructions on how to apply a custom locale for formulas, see the [Localization](localization.md#custom-locale-for-formulas) guide.
...
const en = {
    ...
    "SUMIF": [
        [
            "Range",
            "Required. Range to apply criteria to."
        ],
        [
            "Criteria",
            "Required. Criteria to apply."
        ],
        [
            "Sum_range",
    ...
    "SUMIFS": [
        [
            "Sum_range",
            "Required. The range to be summed."
        ],
        [
            "Range1",
            "Required. The first range to evaluate."
        ],
        [
            "Criteria1",
            "Required. The criteria to use on range1."
        ],
        [
            "Range2",
    ...
    "AVERAGEIF": [
        [
            "Range",
            "Required. One or more cells, including numbers or names, arrays, or references."
        ],
        [
            "Criteria",
            "Required. A number, expression, cell reference, or text."
        ],
        [
            "Average_range",
    ...
    "COUNT": [
        [
            "Value1",
            "Required. An item, cell reference, or range."
        ],
        [
            "Value2",
    ...
    "COUNTIF": [
        [
            "Range",
            "Required. The range of cells to count."
        ],
        [
            "Criteria",
            "Required. The criteria that controls which cells should be counted."
        ]
    ],
    "COUNTIFS": [
        [
    ...
    "MINIFS": [
        [
            "Min_range",
            "Required. Range of values used to determine minimum."
        ],
        [
            "Range1",
            "Required. The first range to evaluate."
    ...
    "MAXIFS": [
        [
            "Max_range",
            "Required. Range of values used to determine maximum."
        ],
        [
            "Range1",
            "Required. The first range to evaluate."
    ...
    "SQRT": [
        [
            "Number",
            "Required. The number to get the square root of."
        ]
    ],
    "POWER": [
        [
            "Number",
            "Required. Number to raise to a power."
        ],
        [
            "Power",
            "Required. Power to raise number to (the exponent)."
        ]
    ],
    "LOG": [
        [
        ...
        [
            "Base",
            "Optional. Base of the logarithm. Defaults to 10."
        ]
    ],
    "EXP": [
        [
    ...
    "PRODUCT": [
        [
            "Number1",
            "Required. The first number or range to multiply."
        ],
        [
            "Number2",
    ...
    "SUMPRODUCT": [
        [
            "Array1",
            "Required. The first array or range to multiply, then add."
        ],
        [
            "Array2",
    ...
    "ABS": [
        [
            "Number",
            "Required. The number to get the absolute value of."
        ]
    ],
    "RAND": [],
    "RANDBETWEEN": [
        ...
        [
            "Top",
            "Required. An integer representing the upper value of the range."
        ]
    ],
    "ROUND": [
        [
        ...
        [
            "Num_digits",
            "Required. The place at which number should be rounded."
        ]
    ],
    "ROUNDUP": [
        [
            "Number",
            "Required. The number to round up."
        ],
        [
            "Num_digits",
            "Required. The place at which number should be rounded."
    ...
    "ROUNDDOWN": [
        [
            "Number",
            "Required. The number to round down."
        ],
        [
            "Num_digits",
            "Required. The place at which number should be rounded."
    ...
    "INT": [
        [
            "Number",
            "Required. The number from which you want an integer."
        ]
    ],
    "CEILING": [
        [
            "Number",
            "Required. The number that should be rounded."
        ],
        [
            "Significance",
            "Required. The multiple to use when rounding."
        ]
    ],
    "FLOOR": [
        [
    ...
    "CONCATENATE": [
        [
            "Text1",
            "Required. The first text value to join together."
        ],
        [
            "Text2",
            "Required. The second text value to join together."
        ],
        [
            "Text3",
    ...
    "MID": [
        [
            "Text",
            "Required. The text to extract from."
        ],
        [
            "Start_num",
            "Required. The location of the first character to extract."
        ],
        [
            "Num_chars",
    ...
    "LOWER": [
        [
            "Text",
            "Required. The text that should be converted to lower case."
        ]
    ],
    "UPPER": [
        [
            "Text",
            "Required. The text that should be converted to upper case."
        ]
    ],
    "PROPER": [
        [
            "Text",
            "Required. The text that should be converted to proper case."
        ]
    ],
    "TRIM": [
        [
            "Text",
            "Required. The text from which to remove extra space."
        ]
    ],
    "LEN": [
        [
    ...
    "SEARCH": [
        ...
        [
            "Within_text",
            "Required. The text to search within."
        ],
        [
            "Start_num",
    ...
    "REPLACE": [
        ...
        [
            "Start_num",
            "Required. The starting location in the text to search."
        ],
        [
            "Num_chars",
        ...
        [
            "New_text",
            "Required. The text to replace old_text with."
        ]
    ],
    "SUBSTITUTE": [
        [
            "Text",
            "Required. The text to change."
        ],
        [
            "Old_text",
            "Required. The text to replace."
    ...
    "DATE": [
        [
            "Year",
            "Required. Number for year."
        ],
        [
            "Month",
            "Required. Number for month."
        ],
        [
            "Day",
            "Required. Number for day."
        ]
    ],
    "TIME": [
        [
            "Hour",
            "Required. The hour for the time you wish to create."
        ],
        [
            "Minute",
            "Required. The minute for the time you wish to create."
        ],
        [
            "Second",
            "Required. The second for the time you wish to create."
        ]
    ],
    "YEAR": [
        [
            "Date",
            "Required. A valid Excel date."
        ]
    ],
    "MONTH": [
        [
    ...
    "HOUR": [
        [
            "Serial_number",
            "Required. A valid Excel time."
        ]
    ],
    "MINUTE": [
        [
            "Serial_number",
            "Required. A valid date or time."
        ]
    ],
    "SECOND": [
        [
            "Serial_number",
            "Required. A valid time in a format Excel recognizes."
        ]
    ],
    "DATEDIF": [
        [
            "Start_date",
            "Required. Start date in Excel date serial number format."
        ],
        [
            "End_date",
            "Required. End date in Excel date serial number format."
        ],
        [
            "Unit",
            "Required. The time unit to use (years, months, or days)."
        ]
    ],
    "INDEX": [
        [
            "Array",
            "Required. A range of cells, or an array constant."
        ],
        [
            "Row_num",
            "Required. The row position in the reference or array."
        ],
        [
            "Col_num",
    ...
    "LOOKUP": [
        ...
        [
            "Lookup_vector",
            "Required. The one-row, or one-column range to search."
        ],
        [
            "Result_vector",
            "Optional. The one-row, or one-column range of results."
        ]
    ],
    "HLOOKUP": [
        [
            "Lookup_value",
            "Required. The value to look up."
        ],
        [
            "Table_array",
            "Required. The table from which to retrieve data."
        ],
        [
            "Row_index",
            "Required. The row number from which to retrieve data."
        ],
        [
            "Range_lookup",
    ...
    "VLOOKUP": [
        ...
        [
            "Table_array",
            "Required. The table from which to retrieve a value."
        ],
        [
            "Column_index_num",
    ...
    "MATCH": [
        [
            "Lookup_value",
            "Required. The value to match in lookup_array."
        ],
        [
            "Lookup_array",
            "Required. A range of cells or an array reference."
        ],
        [
            "Match_type",
    ...
    "CHOOSE": [
        [
            "Index_num",
            "Required. The value to choose. A number between 1 and 254."
        ],
        [
            "Value1",
            "Required. The first value from which to choose."
        ],
        [
            "Value2",
    ...
    "ISEVEN": [
        [
            "Value",
            "Required. The numeric value to check."
        ]
    ],
    "ISODD": [
        [
    ...
    "N": [
        [
            "Value",
            "Required. The value to convert to a number."
        ]
    ],
    "IF": [
        [
    ...
    "ADD": [
        ...
        [
            "Number2",
            "Required. The second value to sum."
        ]
    ],
    "ARABIC": [
        [
    ...
    "ATAN": [
        [
            "Number",
            "Required. The value to get the inverse tangent of."
        ]
    ],
    "ATAN2": [
        [
            "X_num",
            "Required. The x coordinate of the input point."
        ],
        [
            "Y_num",
            "Required. The y coordinate of the input point."
        ]
    ],
    "ATANH": [
        [
            "Number",
            "Required. Any real number between 1 and -1."
        ]
    ],
    "AVEDEV": [
        [
            "Number1",
            "Required. First value or reference."
        ],
        [
            "Number2",
    ...
    "BASE": [
        [
            "Number",
            "Required. The number to convert to a given base."
        ],
        [
            "Radix",
            "Required. The base to convert to."
        ],
        [
            "Min_length",
    ...
    "BINOMDIST": [
        [
            "Number_s",
            "Required. The number of successes."
        ],
        [
            "Trials",
            "Required. The number of independent trials."
        ],
        [
            "Probability_s",
            "Required. The probability of success on each trial."
        ],
        [
            "Cumulative",
    ...
    "BINOM.INV": [
        [
            "Trials",
            "Required. The number of Bernoulli trials."
        ],
        [
            "Probability_s",
            "Required. The probability of a success on each trial."
        ],
        [
            "Alpha",
            "Required. The criterion value."
        ]
    ],
    "BINOM.DIST.RANGE": [
        [
    ...
    "BITAND": [
        [
            "Number1",
            "Required. A positive decimal number."
        ],
        [
            "Number2",
            "Required. A positive decimal number."
    ...
    "BITLSHIFT": [
        [
            "Number",
            "Required. The number to be bit shifted."
        ],
        [
            "Shift_amount",
    ...
    "COMBIN": [
        ...
        [
            "Number_chosen",
            "Required. The number of items in each combination."
        ]
    ],
    "COMBINA": [
        [
    ...
    "COMPLEX": [
        [
            "Real_num",
            "Required. The real number."
        ],
        [
            "I_num",
            "Required. The imaginary number."
        ],
        [
            "Suffix",
            "Optional. The suffix, either \"i\" or \"j\"."
        ]
    ],
    "CORREL": [
        [
    ...
    "COSH": [
        [
            "Number",
            "Required. The hyperbolic angle."
        ]
    ],
    "COT": [
        [
            "Number",
            "Required. The angle provided in radians."
        ]
    ],
    "COTH": [
        [
    ...
    "COUNTBLANK": [
        [
            "Range",
            "Required. The range in which to count blank cells."
        ]
    ],
    "COVAR": [
        [
    ...
    "DEC2BIN": [
        [
            "Number",
            "Required. The decimal number you want to convert to binary."
        ],
        [
            "Places",
    ...
    "DEC2OCT": [
        [
            "Number",
            "Required. The decimal number you want to convert to octal."
        ],
        [
            "Places",
    ...
    "DECIMAL": [
        [
            "Number",
            "Required. A text string representing a number."
        ],
        [
            "Radix",
    ...
    "DIVIDE": [
        [
            "Number1",
            "Required. The number we are dividing."
        ],
        [
            "Number2",
            "Required. The number by which we divide."
        ]
    ],
    "EQ": [
        [
        ...
        [
            "Number2",
            "Required. Second value or reference."
        ]
    ],
    "ERF": [
        [
    ...
    "ERFC": [
        [
            "X",
            "Required. The lower bound for integrating ERFC."
        ]
    ],
    "EVEN": [
        [
            "Number",
            "Required. The number to round up to an even integer."
        ]
    ],
    "FACT": [
        [
            "Number",
            "Required. The number to get the factorial of."
        ]
    ],
    "FACTDOUBLE": [
        [
            "Number",
            "Required. A number greater than or equal to -1."
        ]
    ],
    "FISHER": [
        [
            "X",
            "Required. A numeric value for which you want the transformation."
        ]
    ],
    "FISHERINV": [
        [
    ...
    "IMCSC": [
        [
            "Inumber",
            "Required. A complex number for which you want the cosecant."
        ]
    ],
    "IMCSCH": [
        [
    ...
    "IMPOWER": [
        ...
        [
            "Number",
            "Required. Power to raise number."
        ]
    ],
    "IMPRODUCT": [
        [
            "Inumber1",
            "Required. Complex number 1."
        ],
        [
            "Inumber2",
    ...
    "IMSEC": [
        [
            "Inumber",
            "Required. A complex number for which you want the secant."
        ]
    ],
    "IMSECH": [
        [
    ...
    "IMTAN": [
        [
            "Inumber",
            "Required. A complex number for which you want the tangent."
        ]
    ],
    "LARGE": [
        [
            "Array",
            "Required. An array or range of numeric values."
        ],
        [
            "K",
    ...
    "LN": [
        [
            "Number",
            "Required. A number to take the natural logarithm of."
        ]
    ],
    "LOG10": [
        [
    ...
    "MINUS": [
        [
            "Number1",
            "Required. The number from which we subtract."
        ],
        [
            "Number2",
            "Required. The number by which we subtract."
        ]
    ],
    "MOD": [
        [
        ...
        [
            "Divisor",
            "Required. The number to divide with."
        ]
    ],
    "MROUND": [
        [
    ...
    "MULTIPLY": [
        [
            "Number1",
            "Required. The number to multiply."
        ],
        [
            "Number2",
            "Required. The number to multiply by."
        ]
    ],
    "NE": [
        [
    ...
    "ODD": [
        [
            "Number",
            "Required. The number to round up to an odd integer."
        ]
    ],
    "PERCENTILE": [
        [
        ...
        [
            "K",
            "Required. Number representing kth percentile."
        ]
    ],
    "PERCENTILE.INC": [
        [
    ...
    "QUARTILE": [
        [
            "Array",
            "Required. A reference containing data to analyze."
        ],
        [
            "Quart",
            "Required. The quartile value to return."
        ]
    ],
    "QUARTILE.INC": [
        [
    ...
    "QUARTILE.EXC": [
        ...
        [
            "Quart",
            "Required. The quartile value to return, 1-3."
        ]
    ],
    "QUOTIENT": [
        [
    ...
    "RADIANS": [
        [
            "Angle",
            "Required. Angle in degrees to convert to radians."
        ]
    ],
    "ROMAN": [
        [
    ...
    "SEC": [
        [
            "Number",
            "Required. The angle in radians for which you want the secant."
        ]
    ],
    "SECH": [],
    "SIGN": [
        [
            "Number",
            "Required. The number to get the sign of."
        ]
    ],
    "SIN": [
        [
    ...
    "SQRTPI": [
        [
            "Number",
            "Required. The number by which pi is multiplied."
        ]
    ],
    "STDEV": [
        [
            "Number1",
            "Required. First number or reference in the sample."
        ],
        [
            "Number2",
    ...
    "STEYX": [
        [
            "Known_y's",
            "Required. An array or range of dependent data points."
        ],
        [
            "Known_x's",
            "Required. An array or range of independent data points."
        ]
    ],
    "SUBTOTAL": [
        [
        ...
        [
            "Ref1",
            "Required. A named range or reference to subtotal."
        ],
        [
            "Ref2",
    ...
    "SUMSQ": [
        [
            "Number1",
            "Required. The first argument containing numeric values."
        ],
        [
            "Number2",
            "Optional. The first argument containing numeric values."
        ]
    ],
    "SUMX2MY2": [
        [
    ...
    "VAR": [
        [
            "Number1",
            "Required. First number or reference."
        ],
        [
            "Number2",
            "Optional. Second number or reference."
    ...
    "WEIBULL": [
        ...
        [
            "Alpha",
            "Required. A parameter to the distribution."
        ],
        [
            "Beta",
            "Required. A parameter to the distribution."
        ...
        [
            "Cumulative",
            "Required. Determines the form of the function."
        ]
    ],
    "WEIBULL.DIST": [
        [
    ...
    "CHAR": [
        [
            "Number",
            "Required. A number between 1 and 255."
        ]
    ],
    "CLEAN": [
        [
            "Text",
            "Required. The text to clean."
        ]
    ],
    "CODE": [
        [
            "Text",
            "Required. The text for which you want a numeric code."
        ]
    ],
    "EXACT": [
        [
            "Text1",
            "Required. The first text string to compare."
        ],
        [
            "Text2",
            "Required. The second text string to compare."
        ]
    ],
    "FIXED": [
        [
            "Number",
            "Required. The number to round and format."
        ],
        [
            "Decimals",
    ...
    "NUMBERVALUE": [
        [
            "Text",
            "Required. The text to convert to a number."
        ],
        [
            "Decimal_separator",
    ...
    "REGEXMATCH": [
        [
            "Text",
            "Required. The text to be tested against the regular expression."
        ],
        [
            "Regular_expression",
    ...
    "REGEXREPLACE": [
        [
            "Text",
            "Required. The text, a part of which will be replaced."
        ],
        [
            "Regular_expression",
    ...
    "REPT": [
        ...
        [
            "Number_times",
            "Required. The number of times to repeat text."
        ]
    ],
    "T": [
        [
            "Value",
            "Required. The value to return as text."
        ]
    ],
    "JOIN": [
        [
    ...
    "ARRAYTOTEXT": [
        [
            "Array",
            "Required. The array or range to convert to text."
        ],
        [
            "Format",
    ...
    "DATEVALUE": [
        [
            "Date_text",
            "Required. A valid date in text format."
        ]
    ],
    "DAYS": [
        [
            "End_date",
            "Required. The end date."
        ],
        [
            "Start_date",
    ...
    "EDATE": [
        [
            "Start_date",
            "Required. Start date as a valid Excel date."
        ],
        [
            "Months",
            "Required. Number of months before or after start_date."
        ]
    ],
    "EOMONTH": [
        [
        ...
        [
            "Months",
            "Required. The number of months before or after start_date."
        ]
    ],
    "ISOWEEKNUM": [
        [
            "Date",
            "Required. A valid Excel date in serial number format."
        ]
    ],
    "NETWORKDAYS": [
        [
        ...
        [
            "Holidays",
            "Optional. A list of non-work days as dates."
        ]
    ],
    "NETWORKDAYS.INTL": [
        [
    ...
    "WORKDAY": [
        ...
        [
            "Days",
            "Required. The working days before or after start_date."
        ],
        [
            "Holidays",
    ...
    "ACCRINT": [
        [
            "Id",
            "Required. Issue date of the security."
        ],
        [
            "Fd",
            "Required. First interest date of security."
        ],
        [
            "Sd",
            "Required. Settlement date of security."
        ],
        [
            "Rate",
            "Required. Interest rate of security."
        ],
        [
            "Par",
            "Required. Par value of security."
        ],
        [
            "Freq",
    ...
    "DB": [
        [
            "Cost",
            "Required. Initial cost of asset."
        ],
        [
            "Salvage",
            "Required. Asset value at the end of the depreciation."
        ],
        [
            "Life",
            "Required. Periods over which asset is depreciated."
        ],
        [
            "Period",
            "Required. Period to calculation depreciation for."
        ],
        [
            "Month",
    ...
    "DOLLARFR": [
        [
            "Decimal_dollar",
            "Required. Pricing as a normal decimal number."
        ],
        [
            "Fraction",
            "Required. The denominator in the fractional unit. 8 = 1/8, 16 = 1/16, 32 = 1/32, etc."
    ...
    "EFFECT": [
        [
            "Nominal_rate",
            "Required. The nominal or stated interest rate."
        ],
        [
            "Npery",
    ...
    "FVSCHEDULE": [
        [
            "Principal",
            "Required. The initial investment sum."
        ],
        [
            "Schedule",
    ...
    "IRR": [
        [
            "Values",
            "Required. Array or reference to cells that contain values."
        ],
        [
            "Guess",
            "Optional. An estimate for expected IRR. Default is .1 (10%)."
        ]
    ],
    "IPMT": [
        [
        ...
        [
            "Per",
            "Required. The payment period of interest."
        ],
        [
            "Nper",
            "Required. The total number of payment periods."
        ...
        [
            "Pv",
            "Required. The present value, or total value of all payments now."
        ],
        [
            "Fv",
    ...
    "ISPMT": [
        ...
        [
            "Per",
            "Required. Period (starts with zero, not 1)."
        ],
        [
            "Nper",
    ...
    "PDURATION": [
        ...
        [
            "Pv",
            "Required. Present value of the investment."
        ],
        [
            "Fv",
            "Required. Future value of the investment."
        ]
    ],
    "PPMT": [
        [
    ...
    "TBILLPRICE": [
        [
            "Settlement",
            "Required. Settlement date of the security."
        ],
        [
            "Maturity",
            "Required. Maturity date of the security."
        ],
        [
            "Discount",
            "Required. The discount rate for the security."
        ]
    ],
    "TBILLYIELD": [
        [
        ...
        [
            "Price",
            "Required. Price per $100."
        ]
    ],
    "UNIQUE": [
        [
            "Array",
            "Required. Range or array from which to extract unique values."
        ],
        [
            "By_col",
            "Optional. How to compare and extract. By row = FALSE (default); by column = TRUE."
        ],
        [
            "Exactly_once",
    ...
    "TOROW": [
        [
            "Array",
            "Required. The array to transform."
        ],
        [
            "Ignore",
            "Required. Control to ignore blanks and errors."
        ],
        [
            "Scan_by_column",
            "Required. Scan array by column. TRUE = by column, FALSE = by row (default)."
        ]
    ],
    "TOCOL": [
        [
        ...
        [
            "Ignore",
            "Required. Setting to ignore blanks and errors."
        ],
        [
            "Scan_by_column",
            "Required. Scan array by column. TRUE = by column, FALSE = by row (default)."
    ...
    "TEXTSPLIT": [
        [
            "Text",
            "Required. The text string to split."
        ],
        [
            "Col_delimiter",
            "Required. The character(s) to delimit columns."
        ],
        [
            "Row_delimiter",
    ...
    "WRAPROWS": [
        [
            "Vector",
            "Required. The array or range to wrap."
        ],
        [
            "Wrap_count",
            "Required. Max values in each row."
        ],
        [
            "Pad_with",
    ...
    "WRAPCOLS": [
        ...
        [
            "Wrap_count",
            "Required. Max values in each column."
        ],
        [
            "Pad_with",
            "Optional. Value to use for unfilled places."
    ...
    "TAKE": [
        [
            "Array",
            "Required. The source array or range."
        ],
        [
            "Rows",
    ...
    "CHOOSEROWS": [
        [
            "Array",
            "Required. The array to extract rows from."
        ],
        [
            "Row_num1",
            "Required. The numeric index of the first row to return."
        ],
        [
            "Row_num2",
    ...
    "CHOOSECOLS": [
        [
            "Array",
            "Required. The array to extract columns from."
        ],
        [
            "Col_num1",
            "Required. The numeric index of the first column to return."
        ],
        [
            "Col_num2",
    ...
    "SORT": [
        [
            "Array",
            "Required. Range or array to sort."
        ],
        [
            "Sort_index",
    ...
    "SORTBY": [
        ...
        [
            "By_array",
            "Required. Range or array to sort by."
        ],
        [
            "Sort_order",
