...
:::info
The **API of version 2.1** is still available, but it is incompatible with the [**API starting from version 3.0**](/api/api_overview/). If you require the documentation for version 2.1, please [contact us](https://dhtmlx.com/docs/contact.shtml), and we will send it to you.
:::
