...
const SITE_NAME = 'DHTMLX Spreadsheet Docs';
const PRODUCT_NAME = 'DHTMLX Spreadsheet';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxSpreadsheet/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/spreadsheet') return 'SoftwareApplication';
