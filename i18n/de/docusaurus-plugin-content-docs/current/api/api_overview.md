...
- ein HTML-Container (oder die ID eines HTML-Containers)
- ein Hash mit Konfigurationsoptionen (siehe unten)

## Spreadsheet-Methoden {#spreadsheet-methods}
...
## Spreadsheet-Events {#spreadsheet-events}
...
## Spreadsheet-Eigenschaften {#spreadsheet-properties}
...
## Sheet Manager-Methoden {#sheet-manager-methods}
...
## Selection-Methoden {#selection-methods}
...
## Events Bus-Methoden {#events-bus-methods}
...
## Export-Methoden {#export-methods}
